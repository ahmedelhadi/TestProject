...
if($show_social == 'true')
{
    ...
    <ul class="social_networks clearfix">
            ...
            ?>
                ...
                <li class="arabic">
                    <a target="_blank" href="http://www.muktasabat.com/realestate/"> <i class="fa fa-lg"><img src="http://www.muktasabat.com/realestate_arabic/wp-content/uploads/2014/10/en.png" /></i></a>
                </li>
                <li class="english">
                    <a target="_blank" href="http://www.muktasabat.com/realestate_arabic/"> <i class="fa fa-lg"><img src="http://www.muktasabat.com/realestate_arabic/wp-content/uploads/2014/10/sa.png" /></i></a>
                </li>
    </ul>
    <?php
}
