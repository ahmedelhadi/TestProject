...
/*
                                    if(!empty($favorites_url)){
                                        ?><a href="<?php echo $favorites_url; ?>"><i class="fa fa-star"></i><?php _e('المفضلة','framework'); ?></a><?php
                                    }

                                    if(!empty($submit_url)){
                                        ?><a href="<?php echo $submit_url; ?>"><i class="fa fa-plus-circle"></i><?php _e('تعميد','framework'); ?></a><?php
                                    }

                                    if(!empty($my_properties_url)){
                                        ?><a href="<?php echo $my_properties_url; ?>"><i class="fa fa-th-list"></i><?php _e('عقاراتي','framework'); ?></a><?php
                                    }*/
                                    ?>
                                    <!--<a href="<?php echo network_admin_url( 'profile.php' ); ?>"><i class="fa fa-user"></i><?php _e('ملفاتي','framework'); ?></a>-->
                                    <a class="last" href="<?php echo wp_logout_url( home_url() ); ?>"><i class="fa fa-sign-out"></i><?php _e(' تسجيل الخروج ','framework'); ?></a>
                                    <?php
                                    ...
                                    if(!empty($theme_login_url)){
                                        ?>
                                        <a class="last" href="<?php echo $theme_login_url; ?>"><i class="fa fa-sign-in"></i><?php _e('تسجيل الدخول / للتسجيل','framework'); ?></a>
                                        <?php
                                    }else{
                                        ?>
                                        <a class="last" href="#login-modal" data-toggle="modal"><i class="fa fa-sign-in"></i><?php _e('تسجيل الدخول / للتسجيل','framework'); ?></a>
                                        <?php
                                    }
                                }
                                ?>
