        ...
        <div class="row">
            ...
            <div class="span12">
                ...
                <div class="main">
                    ...
                    ?>
		    <div class="span3 hm_sec1">
			<h5><?php the_field('title_1'); ?></h5>
			<p><?php the_field('show_your_property'); ?></p>
		    </div>
		    <div class="span3 hm_sec2">
			<h5><?php the_field('title_2'); ?></h5>
			<p><?php the_field('ask_your_property'); ?></p>
		    </div>
		    <div class="span3 hm_sec3">
			<h5><?php the_field('title_3'); ?></h5>
			<p><?php the_field('real_estate_needed'); ?></p>
		    </div>
		    <div class="span3 hm_sec4">
			<h5><?php the_field('title_4'); ?></h5>
			<p><?php the_field('investment_opportunities'); ?></p>
		    </div>
...
<div class="new_res"><?php the_field('newest_real_estate'); ?></div>
