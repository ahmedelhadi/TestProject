...
if (!function_exists('of_options'))
{
    ...
    function of_options()
    {
        ...
        */
        ...
        $options[] = array( "name" => str_replace('display','add',sprintf( $property_detail_option, __('Open Ghraph Meta Tags','framework') )),
            "desc" => __('Yes','framework'),
        ...
        $options[] = array( "name" => __('Rent Prices','framework'),
            ...
            "std" => "Visitors expect smaller values for rent prices, So please provide the list of minimum and maximium rent prices below",
            "type" => "info");
        ...
        $options[] = array( "name" => __('Do you want to disable the pages Title and Subtitle from banner ?','framework'),
            "desc" => __('Yes','framework'),
            "id" => $shortname."_banner_titles",
            "std" => "false",
            "type" => "checkbox");

        $options[] = array( "name" => __('Number of Properties to display on Property Listing Template','framework'),
            "desc" => '',
